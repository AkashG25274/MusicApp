...
NSString * const cover = @"cover";
NSString * const coverSmall = @"cover_small";
NSString * const coverMedium = @"cover_medium";
NSString * const coverBig = @"cover_big";
...
NSString * const artistTabBarTitle = @"Artists";
